...
ini_set("post_max_size","10M");
  ...
  if($errflag == true)
  {
     if(isset($_FILES["ImageArt"]["type"]))
     {
       ...
       if ((($_FILES["ImageArt"]["type"] == "image/png") || ($_FILES["ImageArt"]["type"] == "image/jpg") || ($_FILES["ImageArt"]["type"] == "image/JPG") || ($_FILES["ImageArt"]["type"] == "image/jpeg"))
&& in_array($file_extension, $validextensions)){
     ...
     if ($_FILES["ImageArt"]["size"] > 5000000000) 
     {
