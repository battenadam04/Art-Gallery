				...
				<tr>
					...
					<td>
						...
						<form action="#" class="form-control-other" enctype="multipart/form-data" id="New-art-Form" method="post">
							<p><input class="form-control" name="MAX_FILE_SIZE" type="hidden" value="600000"> Choose an image to add to gallery: <input class="form-control ImageUpload" id="ImageArt" name="ImageArt" type="file"></p><button class=" form-control submit btn btn-primary" id="submitArt" type="button" ng-click="showImg($event)">update</button>
						</form>
					</td>
				</tr>
			</table>
